...
trace_expression('Iterator1', Iterator1) :- Iterator1=((hasNext(1, 'false'):eps)\/(hasNext(1, 'true'):(next(1):Iterator1))), Iterator2=((hasNext(2, 'false'):eps)\/(hasNext(2, 'true'):(next(2):Iterator2))), Main=(Iterator1|Iterator2).
